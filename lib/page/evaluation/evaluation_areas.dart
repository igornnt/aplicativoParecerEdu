              ...
              onTap: (){
                EvaluationProvider.db.getAllEvaluation(1);
                 ...
                 MaterialPageRoute(builder: (context) =>
                  RatingCriteriaPage(codArea: 1, title: linguagens, classSchool: classSchool)
                 ),
                );
            ...
            child: InkWell(
              onTap: (){
                 Navigator.push(
                  context,
                 MaterialPageRoute(builder: (context) =>
                  RatingCriteriaPage(codArea: 2, title: cienciasHumanas, classSchool: classSchool)
                 ),
                );
              },
              splashColor: Colors.blue,
            ...
            child: InkWell(
              onTap: (){
                Navigator.push(
                  context,
                 MaterialPageRoute(builder: (context) =>
                  RatingCriteriaPage(codArea: 3,title: cienciasDaNatureza, classSchool: classSchool)
                 ),
                );
              },
              splashColor: Colors.blue,
            ...
            child: InkWell(
              onTap: (){
                Navigator.push(
                  context,
                 MaterialPageRoute(builder: (context) => 
                 RatingCriteriaPage(codArea: 4,title: matematica, classSchool: classSchool)
                 ),
                );
              },
              splashColor: Colors.blue,
            ...
            child: InkWell(
              onTap: (){
                ...
                Navigator.push(
                  context,
                 MaterialPageRoute(builder: (context) => 
                 RatingCriteriaPage(codArea: 5, title: ensinoReligioso, classSchool: classSchool)
                 ),
                );
