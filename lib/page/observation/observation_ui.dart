          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              return Container(
                ...
                child: FutureBuilder(
                  initialData: 0,
                  future: ObservationProvider.db.countObservation(snapshot.data[index].id),
                  builder: (BuildContext context, AsyncSnapshot<int> newSnapshot){
                    return ListTile(
                      onTap: (){
                        Navigator.pushNamed(context, '/add-observacao', arguments: snapshot.data[index]);
                      },
                      dense: false,
                      enabled: true,
                      title: Text(snapshot.data[index].name),
                      subtitle: Text("Observações registradas: "+newSnapshot.data.toString()),
