...
import 'package:parecer_app/ui/alunos_ui/AdicionarAlunoView.dart';
import 'package:parecer_app/ui/desempenho_individual_ui/alunos_desempenho_ui.dart';
import 'package:parecer_app/ui/observacao_ui/Observacao_page.dart';
            ...
            children: [
              GestureDetector(
                onTap: (){
                  Navigator.push(context,
                      MaterialPageRoute(
                        builder: (context) => AdicionarAlunoView(turmaId,escolaId),
                      )
                  );
                },
                child: Card(
              ...
              GestureDetector(
                ...
                onTap: (){
                  Navigator.push(context, MaterialPageRoute(
                        builder: (context) => AreasConhecimentoView(escolaId,
                            turmaId, avaliar: false),
                      )
                  );
                },
              ),
              GestureDetector(
                ...
                onTap: (){
                  Navigator.push(context,
                      MaterialPageRoute(
                        builder: (context) => AreasConhecimentoView(escolaId,turmaId,avaliar: true),
                      )
                  );
                },
              ),
              ...
              GestureDetector(
                ...
                Navigator.push(context,
                MaterialPageRoute(
                builder: (context) =>  DesempenhoGeral(turmaId, escolaId),
                )
                );
                },
                child: Card(
        ...
        children: <Widget>[
          new Center(
            child: Container(
              child: Stack(
                children: <Widget>[
                  Image.asset(img, height: 50.0, width: 50.0,)
                ],
              ),
            ),
          ),
