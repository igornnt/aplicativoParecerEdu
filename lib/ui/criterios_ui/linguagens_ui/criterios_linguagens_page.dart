...
import 'package:aplicativoescolas/ui/criterios_ui/card_criterios_page.dart';
...
class CriterioLinguagensView extends StatefulWidget {
  ...
  @override
  _CriterioLinguagensViewState createState() => _CriterioLinguagensViewState(
      this.turmaId, this.escolaId, this.tituloAppBar);
}
...
class _CriterioLinguagensViewState extends State<CriterioLinguagensView> {
  ...
  _CriterioLinguagensViewState(String turmaID, String escolaID, String titulo,
      {this.avaliar}) {
    this.turmaId = turmaID;
    this.escolaId = escolaID;
    this.tituloAppBar = titulo;
        ...
        itemBuilder: (context, index) {
          return Container(
            child: Slidable(
                  ...
                  child: IconSlideAction(
                    ...
                    onTap: () {
                      Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) =>
                                CadastrarCriteriosLinguagensView(
                                    turmaId, escolaId,
                                    editar: true,
                                    desc: criterios[index].descricao,
                                    id: criterios[index].id),
                          ));
                    },
                  ),
                ),
              ...
              child: CriteriosView(criterios[index].descricao, escolaId,
                  turmaId, criterios[index].id,
                  avaliar: avaliar),
            ),
          );
        },
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.push(
              ...
              MaterialPageRoute(
                builder: (context) =>
                    CadastrarCriteriosLinguagensView(turmaId, escolaId),
              ));
        },
