...
class DesempenhoIndividual extends StatefulWidget {
  ...
  @override
  _DesempenhoIndividualState createState() => _DesempenhoIndividualState(this.turmaID, this.escolaID, this.alunoID);
}
...
class _DesempenhoIndividualState extends State<DesempenhoIndividual> {
  ...
  _DesempenhoIndividualState(turmaID, escolaID, alunoID){
    ...
    this.escolaID = escolaID;
    this.alunoID = alunoID;
    avaliacoesDataRepository = AvaliacoesDataRepository(this.escolaID, this.turmaID, this.alunoID);
    criterioDataRepository = CriterioDataRepository(this.escolaID, this.turmaID);
      ...
      this.avaliacoes.forEach((avaliacao) => {
        avaliacao.criterioRef.get().then((criterio) => {
          setState(() {
            ...
            ProcessadorDeAvaliacoes processador = ProcessadorDeAvaliacoes(avaliacoesA);
